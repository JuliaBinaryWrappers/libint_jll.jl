...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import libint_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("5fdff7f3-485e-5122-bc58-379aa217adcc"))
platforms = [Pkg.Artifacts.unpack_platform(e, "libint", artifacts_toml) for e in artifacts["libint"]]
...
if best_platform === nothing
    @debug("Unable to load libint; unsupported platform $(triplet(platform_key_abi()))")
else
